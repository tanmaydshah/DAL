			...
			if len(acc) == 3 and len(acc1)==3:
				...
				if sz1<54.00 and sz>60.00:
					if r11<sr1 and r11<r10:
						...
						m.click(mx,my,1)
				if sz<54.00 and sz1<54.00:
					if r1<sr and r1<r0 and r11<sr1 and r11<r10:
						if sx < 0 and sx1<0:
							print 'Wheel UP'
