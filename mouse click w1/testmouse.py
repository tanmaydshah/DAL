...
process1=subprocess.Popen(['python2.7','ser1.py'],shell=False,stdin=subprocess.PIPE,stdout=subprocess.PIPE)
process2=subprocess.Popen(['python2.7','ser2.py'],shell=False,stdin=subprocess.PIPE,stdout=subprocess.PIPE)
